...
public class RentalManageService {
    ...
    @Transactional
    public long countByStockIdAndStatusAndDateIn(String stockid, Long id, Date expectedRentalOn, Date expectedReturnOn) {
        return this.rentalManageRepository.countByStockIdAndStatusAndDateIn(stockid, id, expectedRentalOn, expectedReturnOn);
    }
